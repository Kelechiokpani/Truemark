    ...
    <>
      <section className="pb-20 pt-35 lg:pb-25 lg:pt-45 xl:pb-30 xl:pt-50">
        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          <button
            onClick={() => router.back()}
            className="rounded-2xl inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-[#387467] hover:bg-[#387467] rounded"
          >
           Go Back
          </button>
          <div className="mt-6 flex flex-col-reverse gap-7.5 lg:flex-row xl:gap-12.5">
