...
const faqData: FAQ[] = [
  ...
  {
    id: 2,
    quest: "How long does the certification process take?",
    ans: "The timeline depends on the scope and type of certification. However, most audits are completed within 4–8 weeks from the initial application.",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    ans: "We serve manufacturing, construction, IT, healthcare, education, logistics, and more. Our team will tailor services based on your sector-specific needs.",
  },
];
