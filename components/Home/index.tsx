          ...
          <div className="flex lg:items-center lg:gap-8 xl:gap-32.5">
            ...
            <div className="md:w-1/2">
              ...
              <motion.h2
                ...
                viewport={{ once: true }}
                className="relative ml-[45px] mb-4 text-sm font-[500] text-primary before:absolute before:bg-white before:left-[-45px] before:top-1/2 before:transform before:-translate-y-1/2 before:w-[38px] before:h-0.5 before:mr-8 "
              >
