          ...
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  <h3 className="mb-0.5 text-metatitle2 text-black dark:text-white">
                    - Provide impartial, independent, and reliable certification services
                  </h3>
                </div>
              </div>
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  <h3 className="mb-0.5 text-metatitle2 text-black dark:text-white">
                    - Enhance the competitiveness of Nigerian businesses
                  </h3>
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  <h3 className="mb-0.5 text-metatitle2 text-black dark:text-white">
                    - Support the growth of Nigeria's economy and its integration into the global market
                  </h3>
